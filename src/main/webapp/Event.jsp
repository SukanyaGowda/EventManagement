            ...
            <div class="container">
                ...
                <%
                    ...
                    <div class="container1">
                        <div class="row"> 
                            <div class="col-md-5">
                                <img  src="image/<%=s.getP_image()%>"  class="d-block w-100" height="300" width="100">
                            </div>
                            <div class="col-md-7">
                                <h2><%=s.getP_name()%></h2>
                                ...
                                <% } else {
                                    session.setAttribute("logoutredirect", "Event.jsp?event_category=" + request.getParameter("event_category"));
                                %>
